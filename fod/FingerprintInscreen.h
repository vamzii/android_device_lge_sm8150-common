...
#include <vendor/lge/hardware/displayfeature/1.0/IDisplayFeature.h>
#include <vendor/lge/hardware/fingerprintextension/1.0/ILgeFingerprint.h>
...
using ::vendor::lge::hardware::displayfeature::V1_0::IDisplayFeature;
using ::vendor::lge::hardware::fingerprintextension::V1_0::ILgeFingerprint;
...
class FingerprintInscreen : public IFingerprintInscreen {
  ...
  private:
    sp<IDisplayFeature> lgeDisplayFeatureService;
    sp<ILgeFingerprint> lgeFingerprintService;
